    ...
    <div className="  w-full border-t border-zinc-200">
      {cards.map((card, index) => (
        ...
        >
          ...
          {activeCard === card.id && <Image src={card.imgUrl} width={154} height={220} loading="eager" alt={card.alt} sizes="(max-width: 768px) 112px, 154px" className="max-md:max-w-28 max-md:h-auto rounded-lg" />}
        </motion.div>
      ))}
    </div>
  );
