...
export default function WhyUs() {
  ...
  return (
    ...
    <section className="max-w-380 mx-auto w-full px-5 lg:px-15 xl:px-0  mb-20 flex flex-col items-start gap-10 md:flex md:items-center justify-between md:gap-20 lg:mb-0 lg:flex lg:flex-row ">
